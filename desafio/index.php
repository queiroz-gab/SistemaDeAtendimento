<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $insert = "INSERT INTO pessoas(nome, data_nasc, cpf, sexo, cidade, bairro, rua, numero, complemento) VALUE ('$nome', '$data_nasc', '$cpf', '$sexo', '$cidade', '$bairro', '$rua', '$numero', '$complemento')";
